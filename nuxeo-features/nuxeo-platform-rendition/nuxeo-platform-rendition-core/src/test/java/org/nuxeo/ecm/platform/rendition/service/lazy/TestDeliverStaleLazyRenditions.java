...
public class TestDeliverStaleLazyRenditions {
    ...
    // NXP-27567
    @Test
    public void testOnlyConsiderRenditionUpToDateIfBlobsArePutInTransientStore() {
        // ask for the initial rendition: up-to-date and stored
        checkInitialRendition(true);
        ...
        renditionDefinition.setName(LAZY_AUTOMATION);
        ...
        } while (tsSourceDocumentModificationDate.equals(key));
